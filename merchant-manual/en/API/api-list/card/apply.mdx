...
<Warning>
Card billing addresses are unavailable in certain restricted regions. Before submitting an application, review the billing restricted-region list in [Restricted Scenarios/Regions](/en/FAQ/restricted-scenarios-and-regions).
</Warning>

<Note>
Card applications take time to review: within 30 minutes in the production environment and within 10 minutes in the sandbox environment. If a review remains pending significantly longer, contact technical support.

Cardholding limits:

- **Channel01**: Up to 5 virtual and physical cards combined.
- **Channel02**: Up to 2 virtual cards and 3 physical cards.

Canceled cards do not count toward these limits.
</Note>
