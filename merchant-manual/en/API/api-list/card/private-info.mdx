...
<Note>
**Permission Notes:** The merchant must hold a PCI certificate and have PCI access enabled before calling this endpoint. If access is not enabled, error code **1013** is returned. Merchants without a PCI certificate must retrieve card information through the [Iframe SDK](/en/API/sdk-download).
