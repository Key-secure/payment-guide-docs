...
- See [Appendix - Constants] Push Actions for `action` values.
- The merchant must return `{ "code": 0, "message": "" }`; when `code ≠ 0`, the platform retries according to its retry strategy.
</Note>
...
<ResponseField name="merchant_mcc_category" type="string">MCC category</ResponseField>
...
<ResponseField name="zipcode" type="string">Zipcode</ResponseField>
<ResponseField name="mid" type="string">Merchant MID</ResponseField>
