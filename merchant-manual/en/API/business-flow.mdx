...
2. **Query Balance Details** — Query deposits, withdrawals, consumption, card issuance, and shipping by time range
...
| Query Balance Details | POST | `/open-api/v1/reserve/fund/transaction/list` | Query account balance details by time range, up to 31 days |
