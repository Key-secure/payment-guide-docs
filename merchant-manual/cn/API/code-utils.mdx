...
public class SignUtils {
    ...
    public static String sign(String apiKey, String timestamp, String body, String secretKey) throws Exception {
        return sign(apiKey, timestamp, buildBodyMap(body), secretKey);
    }

    public static String sign(String apiKey, String timestamp, Map<String, String> body, String secretKey) throws Exception {
